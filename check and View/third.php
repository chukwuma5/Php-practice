...
<body>
    ...
    <div id="container">
        ...
        <div class="over-shadow">
            <div class="marion">
                <img src="img/chop2.jpg" alt="chop2 image"><span class="tip-off">-50%</span>
            </div>
            <div class="over-come">
                <ul>
                    <li class="">Name: <span class="same">Black bean burger &#38; juice </span> </li>
                    <li class="">Beverage: <span class="same">Apple juice</span> </li>
