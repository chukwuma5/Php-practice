    ...
    <div id="container">
        ...
        <p>
            <span class="inside"><i id="go-1" class="fas fa-exclamation-circle"></i>These are your saved details
                <?php echo $_SESSION['username']; ?>.
                You can
                always come back to check your item.
            </span>
        </p>
        <section class="fix-it">
            <h3>Vital Information</h3>
            <div class="over-shadow">
                <div class="marion">
                    <img src="img/marion.jpg" alt="marion image"><span class="tip-off">-50%</span>
                </div>
                <div class="over-come">
                    <ul>
                        <li class="">Name: <span class="same">Turkey burger</span> </li>
                        <li class="">Beverage: <span class="same">Marion wine</span> </li>
                        <li class="">price: <span class="same me">$
                        ...
                        <li class="">Order Here &#8594; &nbsp;<a class="only" href="../stock.php">Click Here</a> </li>
                    </ul>
                </div>
            </div>
        </section>
