...
<body>
    ...
    <div id="container">
        ...
        <div class="over-shadow">
            <div class="marion">
                <img src="img/chop4.jpg" alt="chop4 image"><span class="tip-off">-50%</span>
            </div>
            <div class="over-come">
                <ul>
                    <li class="">Name: <span class="same">Chilled milk shake</span> </li>
                    <li class="">Beverage: <span class="same">Pork burger</span> </li>
