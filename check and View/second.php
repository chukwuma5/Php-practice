...
<body>
    ...
    <div id="container">
        ...
        <p>
            <span class="inside"><i id="go-1" class="fas fa-exclamation-circle"></i>These are your saved
        ...
        <div class="over-shadow">
            <div class="marion">
                <img src="img/chop1.jpg" alt="chop1 image"><span class="tip-off">-50%</span>
            </div>
            <div class="over-come">
                <ul>
                    <li class="">Name: <span class="same">Hot elf burger</span> </li>
                    <li class="">Beverage: <span class="same">Milk shake</span> </li>
                    <li class="">price: <span class="same">$<?php echo "$primaryPrice";?></span> </li>
