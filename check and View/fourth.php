...
<body>
    ...
    <div id="container">
        ...
        <div class="over-shadow">
            <div class="marion">
                <img src="img/chop3.jpg" alt="chop3 image"><span class="tip-off">-50%</span>
            </div>
            <div class="over-come">
                <ul>
                    <li class="">Name: <span class="same">Ketchup &#38; fries</span> </li>
                    <li class="">Beverage: <span class="same">Orange juice</span> </li>
                    <li class="">price: <span class="same">$<?php echo "$finalPrice";?></span> </li>
