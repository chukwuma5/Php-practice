...
<body>
    ...
    <div id="container">
        ...
        <div class="over-shadow">
            <div class="marion">
                <img src="img/chop11.jpg" alt="chop12 image"><span class="tip-off">-50%</span>
            </div>
            <div class="over-come">
                <ul>
                    <li class="">Name: <span class="same">Fries, custard &#38; pork burger</span> </li>
                    <li class="">Beverage: <span class="same">Milk shake</span> </li>
                    <li class="">price: <span class="same">$<?php echo "$tetiaryPrice";?></span> </li>
        ...
        <div class="outer">
            <form action="" method="post">
                ...
                $important ="cancel my details";
                                ...
                                $result=header'''  <div id="mySuccess"><h2 title="click to exit" onclick="tabHide()" class="wrong"><i class="far fa-times-circle"></i>&nbsp;Incorrect word output! Try again.
                                </h2></div>';
                                }
                                }
                                ?>
