...
$open_now = "<strong class='open-1'>Yes, we're open! Today's<br> hours are<br> %open% until %closed%.</strong>";
$closed_now = "<strong class='closed-1'>Sorry, we're closed. Today's<br> hours are %open%<br> until %closed%.</strong>";
$closed_all_day = "<strong class='closed-1'>Sorry, we're closed on %day%.</strong>";
$exception = "<strong class='closed-1'>Sorry, we're closed for %exception%.</strong>";
